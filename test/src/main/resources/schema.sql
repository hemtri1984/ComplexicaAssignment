...
create memory tablet if not exists itinerary(ID INT PRIMARY KEY AUTO_INCREMENT, ITINERARYNAME VARCHAR(255) CITYNAME VARCHAR(50), COUNTRY VARCHAR(50), TEMPERATURE FLOAT(6), WEATHER VARCHAR(50), TRAVELDATE VARCHAR(10), ADVICE VARCHAR(50));